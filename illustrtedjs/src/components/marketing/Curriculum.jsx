  ...
  return(
    ...
    <div className="curriculum-box">
      ...
      <div className="curriculum-title">
        <h2>Curriculum</h2>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil earum autem fuga porro ratione, impedit est ea provident maxime culpa officia consequuntur doloremque quibusdam maiores nam totam in nesciunt delectus.</p>
      </div>
        ...
        <div className="ds">
          ...
          <div className="algo">
            <h4>Algorithms</h4>
            <ul className="checked-curr">
              <li className="curriculum-spaced"><img className="check" src={Check}/> &nbsp; Stacks + Queues</li>
              <li><img className="check" src={Check}/> &nbsp; Big O Notation</li>
              <li><img className="check" src={Check}/> &nbsp; Singly Linked Lists</li>
              <li><img className="check" src={Check}/> &nbsp; Doubly Linked Lists</li>
            </ul>
